# Table of Contents
- [Templates (Resume & Cover Letter)](Template.md)
...
- **Q**: How do I ensure only one page is created
    - **A**: See the [Template Documentation](Template.md). Specifically the `Keeping the Output of a Template to One Page` section.
...
- **Q**: How do I generate a cover letter alongside my resume?
    - **A**: Add `cover_letter_template` and `cover_letter_required_fields.py` to your template folder. See the [Template Documentation](Template.md) for details.
